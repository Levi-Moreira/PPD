...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        jlIP.setFont(new Font("Montserrat SemiBold", jlIP.getFont().getStyle(), jlIP.getFont().getSize()));
        jlIP.setText("IP");
        ...
        jlPort = new JLabel();
        jlPort.setFont(new Font("Montserrat SemiBold", jlPort.getFont().getStyle(), jlPort.getFont().getSize()));
        jlPort.setText("Port");
        ...
        label1.setFont(new Font("Montserrat SemiBold", label1.getFont().getStyle(), label1.getFont().getSize()));
        label1.setText("Name");
